---
layout: page
title: "Álbumes de Daft Punk"
permalink: /albumes/
---

# 💿 Discografía de Daft Punk

En esta página encontrarás una recopilación de los **álbumes más importantes de Daft Punk**, junto con una breve descripción de cada uno. Daft Punk dejó un legado único en la música electrónica, mezclando *house*, *funk*, *disco* y sonidos futuristas que cambiaron para siempre el panorama musical.
...
La discografía de Daft Punk es una mezcla única de innovación, creatividad y experimentación sonora. Cada álbum representa una etapa diferente en la evolución del dúo y su impacto en la música sigue siendo enorme.
